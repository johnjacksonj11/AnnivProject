...
var comments = [
    ...
    "Thank you for every piece of you. Thank you for accepting every part of me. The parts the rest of the world weren't meant to see",
...
var overview = [
    ...
    I wish that I was a good enough artist or poet so I could write you a song or poem to really express the extent of my love for you
     ...
     how much your audio means to me, your laugh, your giggle, your lil angry Taylor growl, the way you say my name, all the stories with all their
     ...
     burns, its a dance, back and forth, tossing ashes into the sky as you cover every inch of your story. Thank you for all your love and support, but most of all thank you for being YOU
    `,1000
...
export default function Overview() {
    return (
        <Container className="myText" style={{color:'white',backgroundColor:'black', fontWeight:'bold'}}>
